...
<jsp:useBean id="islem" class="gezi.baglanti"></jsp:useBean>
 ...
 <table>
  ...
  while(rs.next()) { %>
 <form class="modal-content animate" action="gezisilme.jsp" method="post">
  <tbody>
  <tr>
     <td><%=rs.getString("baslik") %></td>
      <td><%=rs.getString("icerik") %></td>
       ...
       <td><input type ="text" name="id" value= "<%=rs.getString("id")%>"readonly></input></td>
       <td>
       <div class="submit">
       <button type="submit" value="SİL" class="button button5">SİL</button>
       </div></td>
  </tr>
   </form>
  <%} %>
