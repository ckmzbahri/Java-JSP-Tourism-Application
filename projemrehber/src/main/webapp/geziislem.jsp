...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; İŞLEMİ SEÇİN</h2>
    ...
    <form  action="geziekle.jsp" method="post">
           <br>
             <div class="submit">
       <button type="submit" value="SİL" align= "center"class="button button5">GEZİ EKLE</button>
       </div>
 </form>
    ...
    <form  action="geziguncelle.jsp" method="post">
           <br>
             <div class="submit">
       <button type="submit" value="SİL" align= "center"class="button button5">GEZİ GÜNCELLE </button>
       </div>
 </form>
 
    <form  action="gezisil.jsp" method="post">
           <br>
             <div class="submit">
       <button type="submit" value="SİL" align= "center"class="button button5">GEZİ SİL</button>
       </div>
 </form>
...
<jsp:useBean id="islem" class="gezi.baglanti"></jsp:useBean>
   <h2 style="color:rgba(72,72,72,0.4)"><b>GEZİ LİSTESİ</b> </h2> 
 <table>
  <tr>
   <th>GEZİ BAŞLIĞI</th>
    <th>GEZİ İÇERİĞİ</th>
