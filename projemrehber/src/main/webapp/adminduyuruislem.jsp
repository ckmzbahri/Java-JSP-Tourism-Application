...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; İŞLEMİ SEÇİN</h2>
    ...
    <form  action="duyuruekle.jsp" method="post">
           <br>
             <div class="submit">
       <button type="submit" value="SİL" align= "center"class="button button5">DUYURU EKLE</button>
       </div>
 </form>
    ...
    <form  action="duyuruguncelle.jsp" method="post">
           <br>
             <div class="submit">
       <button type="submit" value="SİL" align= "center"class="button button5">DUYURU GÜNCELLE </button>
       </div>
 </form>
 
    <form  action="duyurusil.jsp" method="post">
           <br>
             <div class="submit">
       <button type="submit" value="SİL" align= "center"class="button button5">DUYURU SİL</button>
       </div>
 </form>
...
<jsp:useBean id="islem" class="uyeduyuru.baglanti"></jsp:useBean>
   <h2 style="color:rgba(72,72,72,0.4)"><b>DUYURU LİSTESİ</b> </h2> 
 <table>
  <tr>
   <th>DUYURU BAŞLIĞI</th>
    <th>DUYURU İÇERİĞİ</th>
    <th>FOTOĞRAF ADRESİ</th>
     <th>DUYURU NO</th>
     
  <% 
  ResultSet rs=islem.selectAllData();
  while(rs.next()) { %>
 <form class="modal-content animate" action="duyuruguncelliyom.jsp" method="post">
  <tbody>
  <tr>
