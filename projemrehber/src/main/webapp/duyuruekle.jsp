...
<div id="form-main">
<div id="form-div">
<form class="form" id="form1"action="duyuruekleview.jsp" method="post">
<font face="tahoma" size="4" color="tan">YENİ DUYURU</font>
  <br>
  <br>
<jsp:useBean id="veri" class="adminprofil.getset" scope="page" ></jsp:useBean>
<jsp:useBean id="data" class="adminprofil.baglanti" scope="page"></jsp:useBean>
...
<p class="foto">
<input name="foto" required= "required" type="text"  id="foto"/>
</p>
