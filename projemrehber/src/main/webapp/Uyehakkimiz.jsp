...
<table id="myTable">
  ...
  <tr>
  <br>
   <img src= "https://sosyalmedya.co/wp-content/uploads/2017/09/dunya-turu-940x470.jpg"  align="center"/> 
  <br>
  <br>
  ...
  <tr>
  <br>
    <font face="tahoma" size="10" color="orange"><%=rs.getString("baslik") %></font>
  </tr>
  <br>
  <tr>
  <br>
    <font face="tahoma" size="5" color="tan"><%=rs.getString("icerik") %></font>
  </tr>
  <br>
  </tr> 
    <%} %>
