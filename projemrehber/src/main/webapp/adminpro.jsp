...
<div id="form-main">
<div id="form-div">
<form class="form" id="form1"action="adminproview.jsp" method="post">
...
<p class="mail">
<input name="mail" type="email" class="validate[required,custom[]] feedback-input" required= "required" id="mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"title="E-mail formatında giriniz." value="<%=rs.getString("mail") %>" />
</p>
...
<p class="sifre">
<input name="tel" type="number" class="validate[required,custom[]] feedback-input" required= "required" id="tel"  pattern="[0-9]{10}"  title=" telefon numaranızı 10 rakam olarak giriniz" value="<%=rs.getString("tel") %>" />
</p>
<div class="submit">
