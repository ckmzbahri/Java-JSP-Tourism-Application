...
<div class="coupon">
  ...
  <div class="container" style=" background-color:rgba(72,72,72,0.4);width: 800px;">
    <h2 style="color:tan"><b><%=rs.getString("baslik") %></b>(<b><%=rs.getString("konum") %></b>) </h2> 
     <div class="column">
    ...
    <div class="imgcontainer">
      ...
      <br>
      <br>    
      <h1 style="color:rgba(72,72,72,0.4)"><b><%=rs.getString("baslik") %></b>(<b><%=rs.getString("konum") %></b> ) </h1>
        <div class="column">
    <img src="<%=rs.getString("foto") %>" alt="Nature" style="width:40%">
  </div>
     <h3><b><%=rs.getString("icerik") %></b> </h3>
        <h4><b><%=rs.getString("tur") %></b></h4>         
    </div>
</div> 
  </div>
</div>
