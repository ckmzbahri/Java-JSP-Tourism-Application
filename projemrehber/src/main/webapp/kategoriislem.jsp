...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; İŞLEMİ SEÇİN</h2>
    ...
    <form  action="kategoriekle.jsp" method="post">
           <br>
             <div class="submit">
       <button type="submit" value="SİL" align= "center"class="button button5">KATEGORİ EKLE</button>
       </div>
 </form>
    ...
    <form  action="kategoriguncelle.jsp" method="post">
           <br>
             <div class="submit">
       <button type="submit" value="SİL" align= "center"class="button button5">KATEGORİ GÜNCELLE </button>
       </div>
 </form>
    ...
    <form  action="kategorisil.jsp" method="post">
           <br>
             <div class="submit">
       <button type="submit" value="SİL" align= "center"class="button button5">KATEGORİ SİL</button>
       </div>
 </form>
...
<jsp:useBean id="islem" class="kategori.baglanti"></jsp:useBean>
   <h2 style="color:rgba(72,72,72,0.4)"><b>KATEGORİ LİSTESİ</b> </h2> 
 <table>
  <tr>
    <th>TÜR</th>
     <th>KATEGORİ NO</th>
