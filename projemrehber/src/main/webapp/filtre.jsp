...
<nav class="navbar navbar-inverse">
  ...
  <jsp:useBean id="verim" class="kategori.getset"></jsp:useBean>
     ...
     <% 
  ResultSet rs=datam.selectAllData();
  while(rs.next()) { %>
...
<div class="coupon">
  ...
  <div class="container" style=" background-color:rgba(72,72,72,0.4);width: 800px;">
    ...
    <img src="<%=r.getString("foto") %>" alt="Nature" style="width:100%" onclick="myFunction(this);">
     ...
     <h4> <a onclick="document.getElementById('<%=r.getString("id") %>').style.display='block'" style="width:auto;"> İNCELE...</a></h4>

      <div id="<%=r.getString("id") %>" class="modal <%=r.getString("id") %>"  style=" background-color:orange"; >
    <div class="imgcontainer">
      <h1 style="color:black"><a onclick="document.getElementById('<%=r.getString("id") %>').style.display='none'" class="close" title="Close Modal">GERİ DÖN</a></h1>
      <br>
      <br>    
