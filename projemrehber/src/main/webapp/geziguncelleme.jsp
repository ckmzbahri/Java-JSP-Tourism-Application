...
<body>
  ...
  <form name="mainForm" class="modal-content animate" action="geziguncelleview.jsp" method="post">
    <div class="imgcontainer">
      <h2 style="color:rgba(72,72,72,0.4)"><b>GEZİ BİLGİLERİ</b> </h2> 
 <%
boolean sonuc=false;
...
<font face="tahoma" size="4" color="rgba(72,72,72,0.4)">BAŞLIK</font>
<p class="baslik">
<input name="baslik" type="text" required= "required" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input" value="<%=rs.getString("baslik") %>" id="baslik"/>
</p>
      
      
<font face="tahoma" size="4" color="rgba(72,72,72,0.4)">İÇERİK</font>
<p class="icerik">
<textarea name="icerik" type="text" required= "required" class="validate[required,custom[onlyLetter],length[0,300]] feedback-input" value="<%=rs.getString("icerik") %>" id="icerik"><%=rs.getString("icerik") %></textarea>
</p> 
      
      
<font face="tahoma" size="4" color="rgba(72,72,72,0.4)">FOTOĞRAF ADRESİ</font>
<p class="foto">
<textarea name="foto" type="text" required= "required" class="validate[required,custom[onlyLetter],length[0,300]] feedback-input" value="<%=rs.getString("foto") %>" id="foto"><%=rs.getString("foto") %></textarea>
</p> 
 
  <font face="tahoma" size="4" color="rgba(72,72,72,0.4)">KONUM</font>
<p class="konum">
<textarea name="konum" type="text" required= "required" class="validate[required,custom[onlyLetter],length[0,300]] feedback-input" value="<%=rs.getString("konum") %>" id="konum"><%=rs.getString("konum") %></textarea>
</p> 
  <font face="tahoma" size="4" color="rgba(72,72,72,0.4)">TÜR</font>
  <select  id="tur" name="tur" face="tahoma" style="width: 382px; height: 40px;"">
     <% 
 ...
 <form action="geziguncelle.jsp" method="post">
           <br>
             <div class="submit">
