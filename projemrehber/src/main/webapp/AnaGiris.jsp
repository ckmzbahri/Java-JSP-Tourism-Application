  ...
  <form class="modal-content animate" action="Uyeview.jsp" method="post">
    ...
    <div class="container">
     <label for="uname"><b> Ad</b></label>
      <input type="text"  placeholder="AD" name="ad" required= "required" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input" >
       <label for="uname"><b>Soyad</b></label>
      <input type="text" placeholder="SOYAD" name="soyad" required= "required" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input" >
       <label for="uname"><b>Mail</b></label>
      <input type="text" placeholder="MAİL" name="mail" class="validate[required,custom[]] feedback-input" id="mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"title="E-mail formatında giriniz." required>
      
      <label for="uname"><b>Telefon</b></label>
      <input type="text" placeholder="TELEFON" name="tel" class="validate[required,custom[]] feedback-input" required= "required" id="tel"  pattern="[0-9]{10}"  title=" telefon numaranızı 10 rakam olarak giriniz">
      
      <label for="uname"><b>Kullanıcı Adı</b></label>
      <input type="text" placeholder="KULLANICI ADI" name="kullanici"  required= "required" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input">

      <label for="psw"><b>Şifre</b></label>
      <input type="password" placeholder="ŞİFRE" name="sifre" class="validate[required,custom[]] feedback-input" required= "required" id="sifre" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{5,}" title=" Şifre en az 5 karakter,en az bir büyük,en az bir küçük harf">
